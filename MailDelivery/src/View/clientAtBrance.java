...
private JButton Queue=new JButton("קח מספר");//creating instance of JButton 
private JButton submit =new JButton("אישור");//creating instance of JButton 
private int num;
private JLabel Qnum=new JLabel("");
	...
	public void setBound()
	{
		...
		Queue.setBounds(350,170,250, 30);//x axis, y axis, width, height  
		Qnum.setBounds(150,150,150,30);
	}
	public void add()
	{
		frame.add(Queue);//adding to JFrame  
		frame.add(text); 
		frame.add(lable);  
		frame.add(submit);
		frame.add(Qnum);
